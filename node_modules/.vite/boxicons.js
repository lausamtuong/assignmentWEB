    ...
    !function(t, e, n, r, o) {
      ...
      function c(t2) {
        ...
        return n2.type = "text/javascript", n2.readyState ? n2.onreadystatechange = function() {
          n2.readyState != "loaded" && n2.readyState != "complete" || (n2.onreadystatechange = null, e2.isDone = true, e2.exec());
        } : n2.onload = function() {
      ...
      t = window, e = function() {
        return function(t2) {
          ...
          return n.m = t2, n.c = e2, n.d = function(t3, e3, r) {
            ...
            if (n.r(r), Object.defineProperty(r, "default", { enumerable: true, value: t3 }), 2 & e3 && typeof t3 != "string")
              for (var o in t3)
                n.d(r, o, function(e4) {
                  return t3[e4];
                }.bind(null, o));
          ...
          t2.exports = function(t3) {
            ...
            return e3.toString = function() {
              ...
              for (o = 0; o < t4.length; o++) {
                var i = t4[o];
                typeof i[0] == "number" && r[i[0]] || (n && !i[2] ? i[2] = n : n && (i[2] = "(" + i[2] + ") and (" + n + ")"), e3.push(i));
              }
            }, e3;
          };
        }, function(t2, e2, n) {
          var r = n(3);
          t2.exports = typeof r == "string" ? r : r.toString();
        }, function(t2, e2, n) {
          var r = n(4);
          t2.exports = typeof r == "string" ? r : r.toString();
        }, function(t2, e2, n) {
          ...
          var r, o, a, i, s = n(1), f = n.n(s), c = n(2), l = n.n(c), m = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(t3) {
            return typeof t3;
          } : function(t3) {
          ...
          }, i = (typeof Reflect == "undefined" ? "undefined" : m(Reflect)) === "object" ? Reflect.construct : function(t3, e3, n2) {
            var r2, o2 = [null];
          ...
          var g = d(function(t3) {
            function e3() {
              ...
              var t4 = function(t5, e4) {
                ...
                return !e4 || typeof e4 != "object" && typeof e4 != "function" ? t5 : e4;
            ...
            return function(t4, e4) {
              ...
              return e4 === "solid" ? n2 = this.cdnUrl + "/solid/bxs-" + t4 + ".svg" : e4 === "logo" && (n2 = this.cdnUrl + "/logos/bxl-" + t4 + ".svg"), n2 && b[n2] || (b[n2] = new Promise(function(t5, e5) {
              ...
              switch (t4) {
                case "type":
                  !function(t5, e5, n3) {
                    var r3 = t5._state;
                    r3.$iconHolder.textContent = "", r3.type && (r3.type = null), r3.type = !n3 || n3 !== "solid" && n3 !== "logo" ? "regular" : n3, r3.currentName !== void 0 && t5.constructor.getIconSvg(r3.currentName, r3.type).then(function(t6) {
                ...
                case "name":
                  !function(t5, e5, n3) {
                    var r3 = t5._state;
                    r3.currentName = n3, r3.$iconHolder.textContent = "", n3 && r3.type !== void 0 && t5.constructor.getIconSvg(n3, r3.type).then(function(t6) {
      ...
      }, typeof exports == "object" && typeof module == "object" ? module.exports = e() : typeof define == "function" && define.amd ? define([], e) : typeof exports == "object" ? exports.BoxIconElement = e() : t.BoxIconElement = e();
    });
  }
});
